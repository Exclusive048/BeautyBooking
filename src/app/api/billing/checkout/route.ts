...
export async function POST(req: Request) {
  ...
  if (!parsed.success) {
    ...
    return fail("РќРµРІРµСЂРЅС‹Рµ РґР°РЅРЅС‹Рµ РѕРїР»Р°С‚С‹.", 400, "VALIDATION_ERROR");
  ...
  if (!plan || !plan.isActive) {
    ...
    return fail("РўР°СЂРёС„ РЅРµ РЅР°Р№РґРµРЅ.", 404, "NOT_FOUND");

  }

  if (plan.scope !== scope) {

    return fail("РўР°СЂРёС„ РЅРµ РѕС‚РЅРѕСЃРёС‚СЃСЏ Рє РІС‹Р±СЂР°РЅРЅРѕРјСѓ СЂР°Р·РґРµР»Сѓ.", 400, "VALIDATION_ERROR");
  ...
  if (priceKopeks === null) {
    ...
    return fail("Р¦РµРЅР° РґР»СЏ РІС‹Р±СЂР°РЅРЅРѕРіРѕ СЃСЂРѕРєР° РЅРµ РЅР°Р№РґРµРЅР°.", 404, "NOT_FOUND");
  ...
  if (!subscriptionId) {
    ...
    return fail("РќРµ СѓРґР°Р»РѕСЃСЊ СЃРѕР·РґР°С‚СЊ РїРѕРґРїРёСЃРєСѓ.", 500, "SUBSCRIPTION_ERROR");
  ...
  if (existingByKey) {
    ...
    return fail("?????? ??? ???????. ?????????? ?????.", 409, "PAYMENT_ALREADY_EXISTS");
  ...
  try {
    ...
    return fail("РќРµ СѓРґР°Р»РѕСЃСЊ СЃРѕР·РґР°С‚СЊ РѕРїР»Р°С‚Сѓ.", 500, "PAYMENT_ERROR");
