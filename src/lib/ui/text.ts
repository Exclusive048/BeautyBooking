...
export const UI_TEXT = {
  ...
  auth: {
    ...
    logoutPending: "Выход...",
    loginPage: {
      heroTitle: "Запишись к мастеру без звонков",
      heroSubtitle: "Выбирай по фото и отзывам, а время бронируй онлайн",
      title: "Вход по номеру телефона",
      subtitle: "Введи номер - пришлем код. Без пароля.",
      phoneLabel: "Телефон",
  ...
  settings: {
    ...
    telegram: {
      ...
      hint: "Получай уведомления о новых записях прямо в Telegram",
      connect: "Подключить",
    },
    vk: {
      title: "Уведомления ВКонтакте",
      hint: "Получай уведомления о записях в VK",
      connect: "Подключить",
    ...
    billing: {
      featureGate: {
        ...
        hint: "Перейди на Про чтобы разблокировать эту функцию",
        cta: "Перейти на Про",
      },
    },
    notifications: {
  ...
  studio: {
    ...
    profileForm: {
      ...
      descriptionPlaceholder:
        "Расскажи о студии — атмосфера, специализация, команда",
      addressLabel: "Адрес",
  ...
  catalog: {
    ...
    emptyDesc: "Попробуйте другой запрос или район.",
    retry: "Повторить",
  },
  analytics: {
    labels: {
  ...
  master: {
    ...
    dashboard: {
      ...
      prompts: {
        ...
        rescheduleStart: "Новая дата и время начала (YYYY-MM-DDTHH:mm)",
  ...
  studioCabinet: {
    ...
    profile: {
      ...
      descriptionPlaceholder: "Расскажи о студии — атмосфера, специализация, команда",
