...
export const UI_TEXT = {
  ...
  adminPanel: {
    ...
    page: {
      dashboard: {
        title: "Дашборд",
        sublabel: "ключевые метрики и события",
      },
      catalog: {
        title: "Каталог",
        sublabel: "категории, теги, услуги",
      },
      cities: {
        title: "Города",
        sublabel: "управление списком городов",
      },
      users: {
        title: "Пользователи",
        sublabel: "клиенты, мастера, студии",
      },
      billing: {
        title: "Финансы и тарифы",
        sublabel: "планы, платежи, подписки",
      },
      reviews: {
        title: "Отзывы",
      ...
      settings: {
        ...
        sublabel: "конфигурация платформы",
      },
    },
    role: {
    ...
    aria: {
      sidebar: "Главная навигация админ-панели",
      breadcrumb: "Хлебные крошки",
    },
    dashboard: {
      kpi: {
        registrations7d: "Новых регистраций · 7д",
        bookings1d: "Записей за сутки",
        activeSubs: "Активных подписок",
        revenueMonth: "Выручка платформы · мес",
        deltaUnavailable: "—",
        deltaUp: "↑",
        deltaDown: "↓",
        deltaTooltipPositive: "vs прошлый период",
        deltaTooltipNegative: "vs прошлый период",
      },
      charts: {
        registrationsTitle: "Регистрации за 7 дней",
        registrationsDeltaSuffix: "vs прошлая неделя",
        bookingsTitle: "Записи за 7 дней",
        bookingsDeltaSuffix: "к прошлой неделе",
        todayLabel: "сегодня",
        tooltipRegistrations: "Регистраций",
        tooltipBookings: "Записей",
        ariaLabelRegistrations: "Бар-чарт регистраций по дням за 7 дней",
        ariaLabelBookings: "Линейный график записей по дням за 7 дней",
      },
      feed: {
        ...
        eventTypes: {
          booking: "Запись",
          bookingCancel: "Отмена записи",
          registrationMaster: "Регистрация · мастер",
      ...
      health: {
        ...
        stats: {
          ...
          p95: "Время ответа p95",
          queuePending: "Очередь задач",
          queueDead: "Мёртвые задачи",
          complaintsOpen: "Жалобы без модерации",
      ...
      errors: {
        loadKpis: "Не удалось загрузить метрики. Попробуйте ещё раз.",
        loadCharts: "Не удалось загрузить графики. Попробуйте ещё раз.",
        loadEvents: "Не удалось загрузить события. Попробуйте ещё раз.",
        loadHealth: "Не удалось загрузить статус системы. Попробуйте ещё раз.",
      },
    },
    catalog: {
      header: {
        captionRoot: "Каталог",
        captionTotal: "категорий",
        captionPending: "на модерации",
      },
      ...
      rejectDialog: {
        title: "Отклонить категорию",
        description: "Причина будет видна только администраторам.",
        reasonLabel: "Причина отклонения",
        reasonPlaceholder: "Например: дубликат существующей категории",
        cancel: "Отмена",
        confirm: "Отклонить",
        errorMinLength: "Минимум 3 символа",
        errorMaxLength: "Максимум 500 символов",
      },
      createDialog: {
        titleNew: "Новая категория",
        titleEdit: "Редактирование категории",
        nameLabel: "Название",
        namePlaceholder: "Например: Татуаж бровей",
      ...
      toasts: {
        ...
        approved: "Категория опубликована",
        rejected: "Категория отклонена",
        cycleError: "Нельзя сделать категорию дочерней самой себе.",
    ...
    cities: {
      ...
      findDuplicates: "Найти дубли",
      addCity: "Добавить город",
      providersWithoutCity: {
        title: "Провайдеры без города",
        hintSingle: "1 провайдер требует geocoding",
        hintPlural: "{count} провайдеров требуют geocoding",
      },
      filters: {
        status: {
          all: "Все",
      ...
      autoCreated: {
        tooltip: "Создан автоматически из адреса мастера",
      },
      duplicateMarker: {
        label: "Дубль",
      },
      ...
      detail: {
        empty: {
          ...
          hint: "Чтобы редактировать или объединить с другим",
        },
        caption: "Город",
        fields: {
          name: "Название",
          nameGenitive: "Родительный падеж",
          nameGenitiveHint: "Для «в Москве». Если пусто — используется именительный",
          latitude: "Широта",
          longitude: "Долгота",
          timezone: "Часовой пояс",
          sortOrder: "Порядок",
          sortOrderHint: "Меньше — выше в списке",
          isActive: "Видимый в каталоге",
          isActiveHint: "Иначе город скрыт от клиентов",
          autoCreated: "Проверен админом",
          autoCreatedHint:
            "Включите, если город проверен вручную. Иначе он будет помечен иконкой авто-создания.",
        },
        duplicate: {
          title: "Найден дубль",
          description:
            "Этот город — дубль «{canonicalName}». Слияние перенесёт всех мастеров и студий в оригинал, а этот город удалит.",
          mergeButton: "Слить с оригиналом",
        },
        actions: {
          save: "Сохранить",
          delete: "Удалить",
      ...
      createDialog: {
        title: "Новый город",
        nameLabel: "Название",
        namePlaceholder: "Например: Калуга",
        slugLabel: "Slug",
        slugHint: "Авто-генерация из названия. Латиница, цифры, дефисы",
        slugEditMode: "Изменить вручную",
        nameGenitiveLabel: "Родительный падеж",
        latitudeLabel: "Широта",
        longitudeLabel: "Долгота",
        timezoneLabel: "Часовой пояс",
        sortOrderLabel: "Порядок",
        isActiveLabel: "Сразу видим",
        cancel: "Отмена",
        save: "Создать",
        errorName: "Укажите название",
        errorCoords: "Координаты должны быть числами",
      },
      mergeDialog: {
      ...
      deleteDialog: {
        title: "Удалить город",
        bodyEmpty: "Город «{name}» будет удалён. Это действие нельзя отменить.",
        bodyBlocked:
          "Нельзя удалить «{name}»: к городу привязано {count} провайдеров. Сначала смерджите его с другим или переназначьте провайдеров.",
        cancel: "Отмена",
        delete: "Удалить",
      },
      duplicateGroupsModal: {
        title: "Найденные дубли",
        reasonNormalize: "Одинаковое название после нормализации",
        reasonGeo: "Координаты ближе 5 км",
        canonicalBadge: "Каноничный",
        mergeIntoCanonical: "Слить с каноничным",
        empty: "Дублей не найдено",
      },
      toasts: {
        created: "Город добавлен",
        updated: "Изменения сохранены",
    ...
    users: {
      ...
      planChange: {
        ...
        currentLabel: "Текущий тариф",
        scopeLabel: "Контекст",
        tierLabel: "Новый тариф",
        periodLabel: "Период",
        periodMonths: {
          "1": "1 месяц",
          "3": "3 месяца",
        ...
        reasonPlaceholder: "Например: компенсация за технический сбой",
        reasonHint: "Сохраняется в журнал. Видна только администраторам.",
        cancel: "Отмена",
        apply: "Применить тариф",
        sameTierWarning: "Этот тариф уже активен. Изменится только период.",
        unavailable: "Этот пользователь не имеет подписочного scope (не мастер и не студия).",
        planNotFound: "Тариф не найден",
        descriptions: {
          freeMaster: "Бесплатно · базовые функции мастера",
          proMaster: "Расширенные функции, аналитика",
          premiumMaster: "Все функции, без ограничений",
          freeStudio: "Бесплатно · базовый профиль студии",
          proStudio: "Команда мастеров, расширенные функции",
          premiumStudio: "Безлимитная команда, полная аналитика",
        },
      },
      empty: {
    ...
    billing: {
      header: {
        caption: "Финансы и тарифы",
      },
      kpi: {
        mrr: "MRR",
        mrrSubtitle: "к прошлому мес",
        activeSubs: "Активные подписки",
        activeSubsDelta: "за месяц",
      ...
      plans: {
        ...
        sectionMaster: "Для мастеров",
        sectionStudio: "Для студий",
      ...
      editDialog: {
        ...
        fields: {
          ...
          isActiveHint: "Если выключить — план перестанет показываться пользователям, но существующие подписки сохранятся",
          sortOrderLabel: "Порядок",
          sortOrderHint: "Меньше — выше в списке",
        ...
        readonlyNote: "Код, уровень и scope нельзя менять через UI — это инвариантные идентификаторы плана.",
        cancel: "Отмена",
        save: "Сохранить",
      ...
      features: {
        ...
        inheritedFrom: "Унаследовано из {planCode}",
        inheritedFromBase: "Унаследовано из базы",
      ...
      payments: {
        ...
        refundButton: "Вернуть",
        empty: {
          title: "Нет платежей",
          hint: "История платежей появится после первой оплаты.",
        },
        pendingEmpty: "Нет ожидающих подтверждения платежей.",
        loadMore: "Загрузить ещё",
      },
      cancelDialog: {
        title: "Отменить подписку",
        body: "Подписка {user} ({plan}) будет отменена. Доступ сохранится до {until}. Это действие нельзя отменить.",
        bodyNoUntil: "Подписка {user} ({plan}) будет отменена.",
        reasonLabel: "Причина (для аудита)",
        reasonPlaceholder: "Например: запрос пользователя по email",
        cancel: "Отмена",
        confirm: "Отменить подписку",
      },
      refundDialog: {
        title: "Вернуть платёж",
        body: "Вернуть {amount}? Средства будут зачислены на оригинальный способ оплаты в течение 3-7 дней.",
        reasonLabel: "Причина (для аудита)",
        reasonPlaceholder: "Например: ошибка при оплате",
        cancel: "Отмена",
        confirm: "Вернуть",
      },
      methodFallback: "—",
    ...
    reviews: {
      header: {
        caption: "Модерация",
        pendingSuffix: "жалоб ожидают",
      },
      kpi: {
        pendingReports: "Жалоб в очереди",
        pendingUrgentSuffix: "срочные",
        reviewsToday: "Отзывов за день",
        reviewsTodayDelta: "к среднему",
        averageRating: "Средняя оценка",
        averageRatingSubtitle: "по платформе",
        deletedLastWeek: "Удалено за неделю",
        deletedLastWeekContext: "из {total}",
        noData: "—",
      },
      tabs: {
        flagged: "Жалобы",
      ...
      filters: {
        searchPlaceholder: "Поиск по тексту, автору, мастеру",
      },
      card: {
        onTargetPrefix: "На",
      ...
      approveDialog: {
        ...
        body: "Жалобы будут сняты, отзыв вернётся к публичному показу. Действие нельзя отменить.",
        cancel: "Отмена",
        confirm: "Одобрить",
      },
      deleteDialog: {
      ...
      empty: {
        flaggedTitle: "Нет жалоб",
        flaggedHint: "Все отзывы прошли модерацию.",
        lowTitle: "Нет низких оценок",
        lowHint: "Мастера держат высокие оценки.",
        allTitle: "Нет отзывов",
        allHint: "Отзывы появятся после первых записей.",
      },
      pagination: {
        loadMore: "Загрузить ещё",
      },
    ...
    settings: {
      header: {
        ...
        title: "Глобальные параметры платформы",
      },
      sections: {
        logo: {
          title: "Логотип сайта",
          desc: "Используется в navbar рядом с МастерРядом",
          hint: "PNG · 256×256 · до 2 МБ",
        },
        loginHero: {
          title: "Фото для страницы входа",
          desc: "Большое изображение в левой части страницы входа",
        },
        flags: {
          title: "Системные флаги",
          desc: "Глобальные переключатели функций платформы",
          ...
          flags: {
            onlinePaymentsEnabled: {
              ...
              desc: "Можно ли оплачивать запись картой",
            },
            visualSearchEnabled: {
              label: "Визуальный поиск включён",
              desc: "Поиск по фото работ — индексация и выдача",
            },
            legalDraftMode: {
        ...
        seo: {
          title: "SEO-настройки",
          desc: "Заголовок и описание для поисковых систем",
          titleLabel: "SEO-заголовок",
          titlePlaceholder: "МастерРядом — мастера красоты онлайн",
          descriptionLabel: "SEO-описание",
          descriptionPlaceholder: "Маркетплейс мастеров красоты. Запись онлайн, отзывы, прозрачные цены.",
        ...
        queue: {
          title: "Очередь задач",
          desc: "Статус и управление фоновой очередью задач",
          ...
          deadJobsTitle: "Мёртвые задачи",
          deadJobsEmpty: "Мёртвых задач нет.",
          retry: "Перезапустить",
          retrying: "Перезапуск…",
          delete: "Удалить",
        ...
        visualSearch: {
          ...
          desc: "Статистика индексации и запуск переиндексации",
          runIndexButton: "Запустить индексацию",
          runningIndexLabel: "Запускаем индексацию…",
          startedToast: "Индексация запущена",
          tiles: {
            total: "Всего фото",
        ...
        mediaCleanup: {
          title: "Медиа-очистка",
          desc: "Устаревшие и «битые» медиафайлы",
          runCleanupButton: "Запустить очистку",
          runningCleanupLabel: "Очищаем…",
          doneToast: "Очистка завершена",
          tiles: {
            pending: "Записи pending",
            broken: "Битые ссылки",
          },
  ...
  clientCabinet: {
    ...
    bookingsPage: {
      title: "Мои записи",
      subtitle: "История и предстоящие визиты",
      kpiAll: "Всего записей",
      kpiUpcoming: "Ближайшая",
      kpiFinished: "Состоялось",
      kpiSpent3m: "Потрачено за 3 мес.",
      filterAll: "Все",
      filterUpcoming: "Предстоящие",
      filterFinished: "Состоявшиеся",
      filterCancelled: "Отменённые",
      searchPlaceholder: "Поиск по мастеру или услуге…",
      actionChat: "Чат",
      actionReschedule: "Перенести",
      actionIcs: "В календарь",
      actionRoute: "Маршрут",
    ...
    reviews: {
      title: "Мои отзывы",
      subtitle: "Ваши оценки мастерам и студиям",
      kpiTotal: "Всего отзывов",
      kpiAverage: "Средняя оценка",
      kpiResponded: "Ответили мастера",
      kpiPending: "Ждут отзыва",
      filterAll: "Все",
      filterWithReply: "С ответом",
      filterWithoutReply: "Без ответа",
      filterFiveStar: "5 звёзд",
      empty: "Вы ещё не оставили отзывов.",
      emptyCta: "Найти мастера",
      pendingTitle: "Ждут вашего отзыва",
      pendingDescription: "Поделитесь впечатлениями — это поможет другим клиентам.",
      pendingCta: "Оставить отзыв",
      pendingMore: (n: number) => `Ещё ${n}`,
      editAction: "Редактировать",
      deleteAction: "Удалить",
      editWindowHint: "Можно изменить в течение 48 часов после публикации",
      masterReplyLabel: "Ответ мастера",
    ...
    faq: {
      ...
      categoryReviews: "Отзывы",
      categoryAccount: "Аккаунт",
      emptySearch: "Ничего не нашли. Попробуйте другой запрос или напишите нам.",
      supportLinkTitle: "Не нашли ответа?",
      supportLinkDescription:
        "Откройте обращение в поддержку — отвечаем в течение часа в рабочее время.",
      supportLinkCta: "Перейти к поддержке",
      ...
      contactTelegram: "Telegram",
      docsTitle: "Документы",
      docsTerms: "Правила платформы",
      docsPrivacy: "Политика конфиденциальности",
      docsCancellation: "Условия отмены",
      docsConsent: "Согласие на обработку",
    },
    profilePage: {
      title: "Профиль",
      subtitle: "Личные данные, контакты и безопасность",
      headerEyebrow: "Профиль клиента",
      stats: {
        memberSince: (year: string) => `С нами с ${year}`,
        visits: (n: number) => `${n} ${n === 1 ? "визит" : n < 5 ? "визита" : "визитов"}`,
        favorites: (n: number) => `${n} в избранном`,
      },
      sections: {
      ...
      fields: {
        firstName: "Имя",
        firstNamePlaceholder: "Как вас зовут?",
        lastName: "Фамилия",
        lastNamePlaceholder: "Фамилия",
        city: "Город",
        cityPlaceholder: "Москва",
        birthDate: "Дата рождения",
        hideAgeYear: "Скрыть год",
      ...
      completion: {
        ...
        items: {
          ...
          birthDate: "Дата рождения",
          avatar: "Аватар",
          telegram: "Telegram привязан",
          vk: "VK привязан",
        },
        tipTitle: "Совет",
        tipDescription: "Чем подробнее профиль — тем выше шанс, что мастера запомнят вас и предложат удобное окошко.",
      },
      emailVerify: {
        modalTitle: "Подтвердить email",
        modalDescription: "Введите адрес — мы отправим 6-значный код.",
        emailLabel: "Email",
        sendCode: "Отправить код",
        codeLabel: "Код из письма",
        codeHint: "Письмо приходит за 1–2 минуты.",
        resendIn: (sec: number) => `Отправить снова через ${sec} с`,
      ...
      danger: {
        ...
        cardDescription: "Все записи и отзывы будут анонимизированы. Действие необратимо.",
        cardCta: "Удалить аккаунт",
        modalStep1Title: "Удалить аккаунт?",
        modalStep1Body: "Все ваши записи и отзывы будут анонимизированы. Это действие необратимо.",
        modalStep1Continue: "Продолжить",
        modalStep2Title: "Куда отправить код?",
        modalStep2Body: "Выберите способ подтверждения. Код придёт мгновенно.",
        channelSms: "SMS",
        channelEmail: "Email",
        channelTelegram: "Telegram",
        channelVk: "VK",
        sendCode: "Отправить код",
        modalStep3Title: "Введите код подтверждения",
        modalStep3Body: "Мы отправили 6-значный код. Введите его для подтверждения удаления.",
