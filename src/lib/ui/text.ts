  ...
  cabinetMaster: {
    ...
    scheduleSettings: {
      ...
      week: {
        ...
        offLabel: "Выходной",
        onLabel: "Рабочий",
        fixedTimesLabel: "Точки старта записи",
        fixedTimesEmpty: "Пока нет точек старта",
        addFixedTime: "Добавить точку",
        removeFixedTimeAria: "Удалить точку",
        days: {
          mon: "Пн",
          tue: "Вт",
          wed: "Ср",
    ...
    account: {
      ...
      security: {
        ...
        sessionsBody:
          "Это включает текущее устройство. Подробный список устройств появится позже — нужно дополнительно сохранять метаданные о входе.",
