...
export const UI_TEXT = {
  ...
  publicProfile: {
    ...
    slots: {
      ...
      unsubscribeHot: "Отключить уведомления о горящих окошках",
  ...
  pages: {
      ...
      groups: [
        {
          ...
          items: [
            ...
            {
              q: "Что такое горящие окошки?",
              a: "Горящие окошки — срочные свободные окна у мастеров, которые публикуются со скидкой (10–30%). Появляются в специальной ленте «Горящие окошки». Отлично подходят если хотите записаться быстро или сэкономить.",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              a: "Базовый тариф FREE — бесплатно навсегда. Он включает профиль в каталоге, онлайн-запись, расписание и портфолио до 15 фотографий. Карта не нужна. PRO и Premium дают карту, горящие окошки, аналитику и приоритет в каталоге — от 990 ₽/мес.",
            },
            {
    ...
    howItWorks: {
      ...
      description:
        "Узнайте как устроен МастерРядом: роли в системе, онлайн-запись, расписание, горящие окошки и другие возможности платформы.",
      ...
      masterSteps: [
        ...
        },
        {
          step: "04",
          title: "Развивайтесь",
          desc: "Собирайте отзывы, управляйте базой клиентов, запускайте горящие окошки для заполнения окошек.",
        },
      ],
      features: [
        {
    ...
    howToBook: {
      ...
      hotSlotsDescription: [
        "Горящие окошки — это срочные свободные окошки, которые мастера публикуют со скидкой.",
        "Например, у мастера отменилась запись на завтра — он публикует слот со скидкой 20%, и вы видите его в ленте «Горящие окошки».",
        "Идеально если хотите записаться быстро или сэкономить.",
      ],
      hotSlotsCta: "Смотреть горящие окошки →",
    ...
    becomeMaster: {
      ...
      pricingTitle: "Тарифы",
      pricingText:
        "Базовые функции — бесплатно навсегда. PRO и Premium открывают карту, горящие окошки, аналитику и приоритет в каталоге.",
