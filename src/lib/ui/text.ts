  ...
  cabinet: {
    master: {
      schedule: {
        ...
        // DEPRECATED: локальные labels шаблонов не используются, названия приходят из API.
        templateStandard: "Стандартная пятидневка",
        // DEPRECATED: локальные labels шаблонов не используются, названия приходят из API.
        template2x2: "2 через 2",
        dayNames: [
          "Понедельник",
          "Вторник",
          "Среда",
        ...
        errors: {
          ...
          saveWeek: "Не удалось сохранить базовую неделю",
          saveException: "Не удалось сохранить исключение",
          deleteException: "Не удалось удалить исключение",
          loadDayBookings: "Не удалось загрузить записи дня",
        },
        info: {
  ...
  master: {
    ...
    dashboard: {
      ...
      labels: {
        ...
        dayTitle: "Мой день",
        // DEPRECATED: верхний заголовок удален, подпись больше не используется в маршруте.
