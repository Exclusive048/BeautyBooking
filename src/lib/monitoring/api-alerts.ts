...
export function alertQueueBacklog(pendingCount: number): void {
  void sendTelegramAlert(
    ...
    QUEUE_BACKLOG_ALERT_KEY,
    QUEUE_BACKLOG_COOLDOWN_MS
  );
  void alertWarning("Большой backlog очереди задач", { pendingCount });
}
