...
export const UI_TEXTS = {
  ...
  telegram: {
    ...
    hint: "Если бот перестал писать — откройте С‡аС‚ с ботом и нажмите Start.",
  ...
  cabinet: {
    ...
    clientBookingsSubtitle: "Р’аС€и записи к мастерам и в студии.",
  },
  inspiration: {
  ...
  profile: {
    ...
    rolesAddedCanAddMore: "Р’С‹ уже добавили профессиональные роли. Можно добавить РµС‰Рµ.",
    stillClientAddRole: "Р’С‹ пока клиент. Добавьте роль мастера или студии.",
    alreadyMaster: "Р’С‹ уже мастер",
    becomeMaster: "Стать мастером",
    creatingMaster: "Создаем профиль мастера...",
    alreadyStudioOwner: "Р’С‹ уже владелец студии",
